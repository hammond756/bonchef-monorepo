...
export function EditProfileDialog({
    ...
    function renderAvatar() {
        return <ProfileImage src={previewImage} name={displayName} size={64} />
    }
                        ...
                        <div className="relative">
                            ...
                            {previewImage && (
                                <button
                                    ...
                                    className="absolute -top-2 -right-2 flex items-center justify-center rounded-full border border-gray-300 bg-white p-0.5 shadow-sm transition-colors hover:bg-gray-100"
