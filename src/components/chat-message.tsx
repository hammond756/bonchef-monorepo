...
export function ChatMessage({ message, onRecipeSaved, onRetry }: ChatMessageProps) {
    let displayText = ""
    ...
    function renderMessageContent() {
        ...
        return (
            <div className="markdown-content break-words [&_h1]:mt-6 [&_h1]:mb-4 [&_h1]:text-2xl [&_h2]:mt-4 [&_h2]:mb-2 [&_h2]:text-xl [&_h3]:mt-3 [&_h3]:mb-1 [&_li]:my-1 [&_ol]:my-2 [&_p]:my-1 [&_ul]:my-2">
                ...
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        p: ({ ...props }) => <p {...props} className="py-1 whitespace-pre-wrap" />,
    ...
    return (
        ...
        >
            <div
                className={`w-full ${
                    message.type === "user"
                        ? "max-w-[80%] rounded-lg bg-slate-200 p-4 text-black"
                        : "text-black"
                }`}
            >
