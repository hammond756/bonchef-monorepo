...
export function TopBar() {
    ...
    return (
        <div 
        className={cn(
          "sticky top-0 z-40 border-b border-slate-200 bg-white flex items-center justify-between px-4 sm:px-6 lg:px-8 h-[var(--top-bar-height)] shrink-0 transition-transform duration-300 ease-in-out",
