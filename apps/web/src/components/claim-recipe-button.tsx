...
export function ClaimRecipeButton({ recipeId, ownerId, user }: ClaimRecipeButtonProps) {
    ...
    return (
        <div className="sticky z-20 border-b bg-white py-4 shadow-xs">
            <Container>
                <div className="flex flex-col items-center space-y-4 px-4">
                    <div className="max-w-xl space-y-2 text-center">
                        <h2 className="text-xl font-semibold text-gray-900">Dit is jouw recept!</h2>
                        <p className="text-gray-600">
                            Maak een gratis account aan om dit recept te bewaren in je persoonlijke
                            collectie. Je kunt het dan altijd terugvinden en delen met anderen.
                        </p>
                    </div>
                    <Button
                        onClick={handleClaim}
                        className="w-full max-w-sm bg-green-700 font-bold text-white hover:bg-green-900"
                        size="lg"
                    >
                        Sla dit recept op
                    </Button>
