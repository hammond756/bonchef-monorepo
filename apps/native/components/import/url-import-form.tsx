...
export function UrlImportForm({
	...
	const handleUrlSubmit = async () => {
      ...
      setIsLoading(false);
		...
		const sourceType = isVerticalVideoUrl(urlToSubmit)
			? "vertical_video"
			: "url";
			...
			>
				...
				<View className="mb-4">
					<View className="flex-row items-center mb-2">
						...
						<Text className="ml-2 text-gray-700 text-lg">Instagram Reels</Text>
					</View>
					<View className="flex-row items-center mb-2">
						<Ionicons name="musical-notes" size={16} color="#000000" />
						<Text className="ml-2 text-gray-700 text-lg">TikTok&apos;s</Text>
					</View>
					<View className="flex-row items-center mb-3">
						<Ionicons name="link" size={16} color="#2563EB" />
						<Text className="ml-2 text-gray-700 text-lg">Webpagina&apos;s</Text>
					</View>

					<Text className="font-semibold text-gray-900 mb-2">
						Van pagina of video naar recept ✨
					</Text>
					<Text className="text-gray-600 text-lg">
						Superslim omgezet. Meestal spot-on, soms een gok die je zelf moet
						checken.
					</Text>
				</View>
