...
| FR-9 | If a user clicks "Annuleren" *after* making edits, the system **must** show a confirmation dialog. If the user confirms, the system **must** navigate them to the previous page in their browser history. |
